...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post keywords_url, params: { keyword: { company_profile_id: @keyword.company_profile_id, name: @keyword.name, sort_order: @keyword.sort_order } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { company_profile_id: @keyword.company_profile_id, name: @keyword.name, sort_order: @keyword.sort_order } }
