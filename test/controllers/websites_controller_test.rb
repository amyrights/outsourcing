...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { company_profile_id: @website.company_profile_id, url: @website.url } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { company_profile_id: @website.company_profile_id, url: @website.url } }
